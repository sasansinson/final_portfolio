...
import Resume from "../images/Sasan_Sahamimoghaddam_Resume.PDF";
...
function Contact(props) {
  return (
   ...
   <p><img className="contactImg" src={ pdfIcon } alt="github icon" /><a className="contactLink" href={Resume}>Click here to download my resume</a></p>
    ...
    <img className="contactImg" src={ email_icon } alt="email icon" /><a className="contactLink" href="mailto:sasan_2002@yahoo.com">Email me</a>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    </div>
